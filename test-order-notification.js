// Test script to verify order notification functionality
const { sendOrderNotification } = require('./lib/discord-webhook');
...
async function testOrderNotification() {
  ...
  const testOrderData = {
    ...
    totalAmount: 99.99,
    items: [
      { name: 'Premium Diapers', quantity: BroadcastChannel, price: 29.99 }
    ],
